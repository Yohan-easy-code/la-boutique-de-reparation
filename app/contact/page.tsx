...
export default function ContactPage() {
  return (
    <main className="pb-20 sm:pb-0">
      {/* Hero interne premium */}
      <PageHero
        title="Contact"
        subtitle="Appelle-nous, écris sur WhatsApp, ou passe en boutique. On te répond rapidement."
      />

      {/* Ton contenu, adapté + cohérent avec le layout */}
      <section className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <div className="mt-2 max-w-2xl text-white/70">
          <p>
            Besoin d’un devis ? Indique le modèle + le problème (et une photo si
            nécessaire).
          </p>
        </div>
